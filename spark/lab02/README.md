...
# Лаба 02. Создание витрины данных из разных источников: файлы, NoSQL-хранилища, реляционные базы данных
...
![Alt text](../images/img2.png?raw=true "Архитектура")
...
`hdfs:///mf-labs/laba02/weblogs.json`
...
В вашем репо в подпапке lab02 положите data_mart.py.

Проект должен запускаться при помощи spark-submit.
...
* `git_correct` = Тrue/False: в репо mf-spark существует `lab02/data_mart.py`.
